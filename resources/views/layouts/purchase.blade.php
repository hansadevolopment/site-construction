        ...
        <div class="navbar_mega_menu">
            ...
            <div class="dropdown_mega_menu">
                ...
                <div class="dropdown_single_menu_content">
                      <a href={{route('creditor')}}>Creditor</a>
                      <a href={{route('purchase_category')}}>Purchase Category</a>
                      <a href={{route('purchase_location')}}>Purchasing Location</a>
                </div>
            </div>
            ...
            <div class="dropdown_mega_menu">
                ...
                <div class="dropdown_single_menu_content">
                      <a href={{route('grn')}}>Good Receive Note</a>
                      <a href="#">Payment Voucher</a>
                      <a href="#">Purchase Return</a>
                      <a href="#">Debit Note</a>
                      <a href="#">Purchase Settlement</a>
            ...
            <div class="dropdown_mega_menu">
                ...
                <div class="dropdown_single_menu_content">
                      <a href="#">Creditor Statement & Age Analysis Report</a>
                      <a href="#">Creditor Ledger</a>
                </div>
            </div>
