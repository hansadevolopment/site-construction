                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-single-menu-content">
                                ...
                                <li><a href={{route('journal_entry')}}>Purchase Settlement</a></li>
                                <li><a href={{route('journal_entry')}}>Custom Order</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-single-menu-content">
                                <li><a href={{route('chart_of_account')}}>Creditor Statement & Age Analysis Report</a></li>
