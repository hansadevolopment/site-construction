        ...
        <div class="navbar_mega_menu">
            ...
            <div class="dropdown_mega_menu">
                ...
                <div class="dropdown_single_menu_content">
                      <a href={{route('debtor')}}>Debtor</a>
                      <a href={{route('sales_category')}}>Sales Category</a>
                      <a href={{route('sales_location')}}>Sales Location</a>
                      <a href={{route('sales_rep')}}>Sales Rep</a>
                </div>
            </div>
            ...
            <div class="dropdown_mega_menu">
                ...
                <div class="dropdown_single_menu_content">
                      <a href="#">Debtor Statement & Age Analysis Report</a>
                      <a href="#">Debtor Ledger</a>
                </div>
            </div>
