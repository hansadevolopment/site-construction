...
@section('body')
    ...
    <div class="row">
        <div class="col-12">
            <form method="POST" action="{{route('sq_report_process')}}">
                @csrf
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <?php echo $SQR['attributes']['process_message'];  ?>
                            </div>
                        </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-5">
                                        <select name="task_id" id="task_id" class="form-select form-select-sm" >
                                            @if( ($SQR['attributes']['task_id'] != "0") || ($SQR['attributes']['site_id'] != "0") )
                                                @foreach($SQR['site_task'] as $row)
                                                    @if($SQR['attributes']['task_id'] == $row->task_id)
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-5">
                                        <select name="sub_task_id" id="sub_task_id" class="form-select form-select-sm" >
                                            @if( ($SQR['attributes']['sub_task_id'] != "0") || ($SQR['attributes']['task_id'] != "0") )
                                                @foreach($SQR['site_sub_task'] as $row)
                                                    @if($SQR['attributes']['sub_task_id'] == $row->sub_task_id)
